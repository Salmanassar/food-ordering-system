...
import com.food.ordering.system.order.service.data.access.restaurant.exception.RestaurantException;
...
public class RestaurantDataAccessMapper {
    ...
    public Restaurant restaurantEntityToRestaurant(List<RestaurantEntity> restaurants) {
        RestaurantEntity restaurantEntity = restaurants.stream()
                .findFirst().orElseThrow(() -> new RestaurantException("The restaurant could not be found"));
